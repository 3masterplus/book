<div class="card fullwidth tab-link"><nav><a href="<?php echo base_url('dashboard'); ?>">学习中课程</a><a href="<?php echo base_url('dashboard/completed'); ?>" class="on">已完成课程</a></nav></div>
